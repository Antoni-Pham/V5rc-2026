...
//     // ==========================================
//     // ADVANCED REVERSE FIX: Inserted Math Check
//     // ==========================================
//     // If the target point is behind the robot (angle error is greater than 90 or less than -90 degrees)
//     if (fabs(heading_error) > 90.0) {
//       // Invert heading error so the robot targets its rear toward the point
//       heading_error = reduce_negative_180_to_180(heading_error - 180.0);
//       // Invert the distance error so the PID computes a negative drive output (reverse voltage)
...
//     if (fabs(drive_error)<drive_settle_error) { heading_output = 0; } // Added fabs() to handle negative error safely
